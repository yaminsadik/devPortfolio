export const contentConfig = {
  ...
  about: {
    ...
    intro: [
      ...
      "I am also building LED Orchestra, an offline distributed lighting system where ESP32-C6 nodes coordinate addressable LED strips over Matter and Thread. I enjoy working end to end across frontend architecture and UX polish, APIs and data pipelines, embedded systems, and deployment.",
    ],
    skills: {
